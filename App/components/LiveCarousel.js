        ...
        return (
            <View>
                ...
                <View style={{flexDirection:'row',flex:1,margin:10}}>
                    <TouchableOpacity onPress={()=> nav.push('UpcomingLive')} style={{ flex: 1, width: width / 4, height: '100%', backgroundColor: 'black' }}>
                        <Image source={require('../../assets/live.png')} style={{ resizeMode: 'stretch', width: width / 4,height:'100%' }} />
                    </TouchableOpacity>
                <FlatList data={data}
